/* auth-system/thumbnail-min.js */

(function() {
    // الهيكل الكامل للصفحة (HTML + استيراد CSS و JS)
    const thumbnailHTML = `
        <script src="https://cdn.tailwindcss.com"></script>
        <script src="https://html2canvas.hertzen.com/dist/html2canvas.min.js"></script>
        <link rel="stylesheet" href="https://cdn.jsdelivr.net/gh/modweeb-widget/modweeb-tools@main/thumbnail-generator/thumbnail.css" />
